      ...
      <div className="z-10 w-full max-w-5xl flex flex-col items-center">
        {!registered ? (
          ...
          <div className="w-full text-center animate-in fade-in zoom-in duration-500">
            <div className="mx-auto w-24 h-24 bg-gradient-to-tr from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mb-8 shadow-[0_0_40px_rgba(6,182,212,0.4)]">
            ...
            <div className="p-8 rounded-[32px] bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] max-w-2xl mx-auto">
              <div className="grid grid-cols-2 gap-6 text-left">
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wider mb-1">Course</p>
                  <p className="text-lg font-medium text-white">{exam.course}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wider mb-1">Duration</p>
                  <p className="text-lg font-medium text-white">{exam.duration_minute} Minutes</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wider mb-1">Total Marks</p>
                  <p className="text-lg font-medium text-white">{exam.total_marks}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wider mb-1">Status</p>
                  <p className="text-lg font-medium text-cyan-400">Ready to Begin</p>
                </div>
              </div>
              
              <button className="w-full mt-10 h-14 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-lg shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)] transition-all hover:-translate-y-1">
